...
def get_device_id(gas, electric):
    ...
    if gas:
        ...
        meters.append(energy_meter("gas_meter", gas_query["account"]["gasAgreements"][0]["meterPoint"]["meters"][0]["smartGasMeter"]["deviceId"], "gas", 300, datetime.now()-timedelta(seconds=300), ["consumption"]))
